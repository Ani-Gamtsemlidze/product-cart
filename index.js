...
function deleteActive() {
  for (let index = 0; index < lightProducts.length; index++) {
    document
      .getElementsByClassName("light-product")
...
function removeClass() {
  for (let index = 0; index < imageList.length; index++) {
    document
      .getElementsByClassName("image-list")
      [index].classList.remove("active");
  }
}
...
document.querySelector(".cart").addEventListener("click", function () {
  document.querySelector(".sum-price").innerText =
    "$" + count * onePrice + ".00";
...
document
  .querySelector(".menu-tab-mobile")
  .addEventListener("click", function () {
    setTimeout(function () {
      document.querySelector(".menu-bar").style.display = "block";
      document.querySelector(".background-shade-mobile").style.display =
        "block";
    }, 500);
  });
...
document
  .querySelector(".background-shade-mobile")
  .addEventListener("click", function () {
    document.querySelector(".menu-bar").style.display = "none";
    document.querySelector(".background-shade-mobile").style.display = "none";
  });
